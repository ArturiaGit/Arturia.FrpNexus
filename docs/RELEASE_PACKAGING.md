...
This document describes the FrpNexus Windows packaging foundation for the `0.4.0-preview.1` release branch.

## Current Release Decision

Preview publishing is re-enabled by user decision for `release/v0.4.0-preview.1`.
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/publish-velopack-win-x64.ps1 -Version 0.4.0-preview.1
```
...
1. Create or update tag `v0.4.0-preview.1` from the release branch after verification.
2. Create a GitHub Release draft for that tag.
3. Upload the Velopack release folder contents.
4. Upload `FrpNexus-win-x64-0.4.0-preview.1.zip`.
5. Upload `FrpNexus-win-x64-0.4.0-preview.1.sha256.txt`.
...
- Run `powershell -ExecutionPolicy Bypass -File scripts/publish-velopack-win-x64.ps1 -Version 0.4.0-preview.1`.
- Confirm the Velopack installer executable exists under `artifacts/release/FrpNexus-win-x64-0.4.0-preview.1/`.
- Confirm `artifacts/release/FrpNexus-win-x64-0.4.0-preview.1.zip` exists.
- Confirm `artifacts/release/FrpNexus-win-x64-0.4.0-preview.1.sha256.txt` exists.
