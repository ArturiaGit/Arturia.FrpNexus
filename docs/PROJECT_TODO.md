...
- [~] Publish preview release package through Velopack first-stage packaging. Re-enabled by user decision for `release/v0.4.0-preview.1`; MSIX remains deferred until trusted code signing is available.
...
### Phase 4 Sixth Iteration Todo

- [x] Add Velopack first-stage Windows x64 installer packaging.
- [x] Use GitHub Releases as the preview update and artifact distribution source.
