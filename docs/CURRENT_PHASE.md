...
- Explicitly designed Velopack installer packaging and GitHub Releases update metadata for Windows x64 preview builds.
...
- MSIX packaging before a trusted code-signing strategy is available.
